    ...
    sso9: [
        {
            ...
            options: [
                ...
                { text: "🖥️ Настраивать сетевой код, серверы и стабильное подключение игроков", scores: { telecom: 1 } },
                { text: "🎚️ Подключать и калибровать звуковое сопровождение, колонки и микрофоны", scores: { multi: 1 } }
            ]
        },
        {
        ...
        },
        {
            ...
            options: [
                { text: "🛠️ Попробую проверить физический кабель в подъезде, обжимку проводов и коннекторы", scores: { cable: 1 } },
                { text: "🖥️ Зайду в настройки роутера через браузер, проверю IP-адрес и сетевой шлюз", scores: { telecom: 1 } },
        ...
        },
        {
            ...
            options: [
                { text: "🎚️ Стриминг, концертный звук, акустика, студийная запись и VR", scores: { multi: 1 } },
                ...
                { text: "🖥️ ИТ-безопасность, облачные серверы и администрирование сетей", scores: { telecom: 1 } }
            ]
        },
        {
            ...
            options: [
                ...
                { text: "🛠️ Практичный, люблю работать руками и копаться в оборудовании", scores: { cable: 1, radio: 1 } },
    ...
    sso11: [
        {
            ...
            options: [
                ...
                { text: "🖥️ Администрирование маршрутизаторов, настройка IP-адресации и коммутации", scores: { telecom: 1 } },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "🖥️ Работа с сетевым оборудованием в серверных комнатах, настройка \"железа\"", scores: { telecom: 1 } },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "🖥️ Устранять неполадки в работе локальных и глобальных оптоволоконных сетей", scores: { telecom: 1 } },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "🖥️ Облачным хостингом и предоставлением защищенных каналов связи для бизнеса", scores: { telecom: 1 } },
    ...
    vo11: [
        {
            ...
            options: [
                ...
                { text: "🖥️ Telecom Network Architect — планировать масштабные оптоволоконные и 5G/6G сети", scores: { networks: 1 } },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "🖥️ Моделирование распространения радиоволн в плотной городской застройке", scores: { networks: 1 } },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "🖥️ Конфигурированием промышленного сетевого оборудования (Cisco, Huawei)", scores: { networks: 1 } },
        ...
        },
        {
            ...
            options: [
                { text: "🖥️ «Как устроен квантовый интернет и магистральные каналы связи»", scores: { networks: 1 } },
...
function PersonalCabinet({ isOpen, onClose }) {
    ...
    // --- Состояния Теста-Навигатора (Упрощенные) ---
                    ...
                    <div>
                        ...
                        {quizStep === 5 && (
                            <div>
                                ...
                                <div className="cab-quiz-options">
                                    <button className="cab-quiz-btn" onClick={() => { setTargetForm('dnev'); setQuizStep(6); }}>☀️ Дневная форма получения образования</button>
